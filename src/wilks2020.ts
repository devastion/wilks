import { maleValues2020, femaleValues2020 } from "./constants.js";
...
export function calculateWilks(
  ...
  const coefficient = calculateCoefficient(
    gender, metricBodyWeight, maleValues2020, femaleValues2020,
  );
  const wilks = metricTotal * (600 / coefficient);
